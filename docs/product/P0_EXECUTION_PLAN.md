...
- P1-beta：团队 Proposal key 分发（DP-018）✅ 已关闭（ADR-0032，2026-09-12，纯设计）；group epoch 与成员变更（DP-025）✅ 已关闭（ADR-0033，2026-09-12，纯设计）；紧急治理恢复（DP-019）、额度/风险校准（DP-023，需真实使用观测数据）未授权。
