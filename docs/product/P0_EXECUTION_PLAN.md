...
| 5 | 网页端立项（§24.2） | 任务 1/2（身份边界依赖部署与账号） | 范围 DP + web 密钥边界合同 | ✅ C1/C2 已完成（ADR-0030/0031 接受 + DP-027 入册 `0254b11`；实现 `6060bbb`，详见 `docs/test-plans/p1-console-c2-implementation-report.md`）；C3 正式证据未授权 |
