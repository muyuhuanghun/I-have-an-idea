...
| 5 | 网页端立项（§24.2） | 任务 1/2（身份边界依赖部署与账号） | 范围 DP + web 密钥边界合同 | ✅ 已完成（2026-09-11 确认范围；2026-09-12 ADR-0030 六项裁决接受、ADR-0031 合同接受、DP-027 入册，C1 提交纳管）；C2/C3 未授权 |
